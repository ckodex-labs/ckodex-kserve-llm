...
func TestContainersEqual_Identical(t *testing.T) {
	...
	assert.True(t, reconciler.ContainersEqual([]corev1.Container{c}, []corev1.Container{c}))
}

// TestContainersEqual_EmptySlices returns true for two empty slices.
func TestContainersEqual_EmptySlices(t *testing.T) {
	assert.True(t, reconciler.ContainersEqual(nil, nil))
	assert.True(t, reconciler.ContainersEqual([]corev1.Container{}, []corev1.Container{}))
}
...
func TestContainersEqual_DifferentLength(t *testing.T) {
	...
	assert.False(t, reconciler.ContainersEqual([]corev1.Container{c, c}, []corev1.Container{c}))
}
...
func TestContainersEqual_DifferentName(t *testing.T) {
	...
	assert.False(t, reconciler.ContainersEqual([]corev1.Container{a}, []corev1.Container{b}))
}
...
func TestContainersEqual_EnvUnsortedOrder(t *testing.T) {
	...
	a := makeContainer("vllm", "vllm:latest", nil, envA)
	b := makeContainer("vllm", "vllm:latest", nil, envB)
	assert.True(t, reconciler.ContainersEqual([]corev1.Container{a}, []corev1.Container{b}))
}
...
func TestContainersEqual_MultipleContainers(t *testing.T) {
	...
	assert.True(t, reconciler.ContainersEqual([]corev1.Container{c1, c2}, []corev1.Container{c1, c2}))
	assert.False(t, reconciler.ContainersEqual([]corev1.Container{c1, c2}, []corev1.Container{c1, c2diff}))
}
