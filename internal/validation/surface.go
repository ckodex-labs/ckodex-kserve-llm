...
var llmInferenceServiceSurface = []SurfaceContract{
	...
	{Version: "v1alpha2", Path: "parallelism", Disposition: SurfaceRendered, Owner: "vllm runtime adapter and KServe worker path"},
	...
	{Version: "v1alpha2", Path: "speculativeDecoding", Disposition: SurfaceRendered, Owner: "vllm runtime adapter"},
	{Version: "v1alpha2", Path: "kvCache", Disposition: SurfaceRendered, Owner: "vllm runtime and KV transfer configuration"},
	{Version: "v1alpha2", Path: "quantization", Disposition: SurfaceRendered, Owner: "vllm and quant-cpp engine selection"},
